...
public interface Pme00ProjectInfoRepository extends JpaRepository<Pme00ProjectInfoJpo, String> {
    ...
    @Query(value =
            "SELECT \n" +
                    ...
                    ", PRO.CD_V_EXPLAIN\n" +
                    ", PRO.CD_TP_ID \n" +
                    ", PRO.CATEGORY_GROUP_ID \n" +
                    ", PRO.CD_V_INQUIRY_SEQ \n" +
                    ", PRO.CREATED_PROGRAM_ID \n" +
                    ", PRO.CREATION_TIMESTAMP \n" +
                    ", PRO.LAST_UPDATE_PROGRAM_ID \n" +
                    ", PRO.LAST_UPDATE_TIMESTAMP \n" +
            "FROM \n" +
            ...
            "WHERE  1= 1 \n" +
                    ...
                    "AND (:period IS NULL OR (INFO.PERIOD = :period))\n" +
